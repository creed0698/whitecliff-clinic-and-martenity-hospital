...
<a href=" ######### ">SETTINGS</a>
    <ul>
       	...
       	<li><a href="branch.php" style="width:150px;">Add Branch</a></li>
    	<li><a href="Viewbranch.php" style="width:150px;">View Branch</a></li>
       	<li><a href="offeredservice.php" style="width:150px;">Add Services</a></li>
    	<li><a href="Viewofferedservice.php" style="width:150px;">View Services</a></li>
      </ul>
</li>
