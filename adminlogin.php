...
<body class="theme-cyan login-page authentication">
	...
	<div class="container">
		...
		<div class="card">
			<h1 class="title"><span>Whiteliff Clinic and Maternity Hospital</span>Admin Login <span class="msg">Sign in to start your session</span></h1>
			<div class="col-md-12">
