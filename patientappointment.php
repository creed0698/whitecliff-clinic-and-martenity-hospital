...
if (isset($_POST['submit'])) {
    ...
    $sqlappointment = "SELECT * FROM appointment WHERE appointmentdate='$_POST[appointmentdate]' AND appointmenttime='$_POST[appointmenttime]' AND serviceid='$_POST[serv]' AND status='Approved'";
    ...
    if (mysqli_num_rows($qsqlappointment) >= 1) {
        ...
        $sql = "INSERT INTO appointment(appointmenttype,patientid,appointmentdate,appointmenttime,app_reason,status,serviceid,doctorid) values('ONLINE','$lastinsid','$_POST[appointmentdate]','$_POST[appointmenttime]','$_POST[app_reason]','Pending','$_POST[branch]','$_POST[serv]')";
        if ($qsql = mysqli_query($con, $sql)) {
                                        ...
                                        <ul class="row">
                                            <li class="col-sm-6">
                                                <label>
                                                    ...
                                                    <input placeholder="Patient Name" type="text" class="form-control" name="patiente" id="patiente" value="<?php echo $rspatient['patientname'];  ?>" <?php echo $readonly; ?>>
                                                    <i class="icon-user"></i>
                                                </label>
                                            ...
                                            <li class="col-sm-6">
                                                <label>
                                                    <input placeholder="Appointment date" type="text" class="form-control" min="<?php echo date("Y-m-d"); ?>" name="appointmentdate" onfocus="(this.type='date')" id="appointmentdate"><i class="ion-calendar"></i>
                                                </label>
                                            ...
                                            <li class="col-sm-6">
                                                <label>
                                                    <select name="serv" class="selectpicker" id="serv">
