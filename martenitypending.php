...
if (isset($_POST['submit'])) {
	if (isset($_GET['editid'])) {
		...
		$roomid = 0;
		$sql = "UPDATE martenityap SET branchid='$_POST[select5]',serviceid='$_POST[select6]',payid='$_POST[select7]',status='Pending',appointmentdate='$_POST[appointmentdate]',appointmenttime='$_POST[time]' WHERE martenityappointid='$_GET[editid]'";
