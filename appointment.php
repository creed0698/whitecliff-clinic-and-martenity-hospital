...
else
{
   ...
   $sql ="INSERT INTO appointment(patientid, branchid, appointmentdate, appointmenttime, serviceid, status, app_reason) values('$_POST[select4]','$_POST[select5]','$_POST[appointmentdate]','$_POST[time]','$_POST[select6]','$_POST[select]','$_POST[appreason]')";
   if($qsql = mysqli_query($con,$sql))
   {
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="select5" id="select6" class=" form-control show-tick">
